...
```sh
  cd my-folder
  git clone: (https://github.com/emhamza/Hamza-s-portfolio)
```
...
Feel free to check the https://github.com/emhamza/Hamza-s-portfolio/issues
